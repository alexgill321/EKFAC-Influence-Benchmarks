...
python $WORKDIR/evals/pythia_kronfluence.py --data_dir $WORKDIR --cov_batch_num 100 --output_dir $OUTDIR --model_id "EleutherAI/pythia-70m" --query_batch_size 1 --train_batch_size 32