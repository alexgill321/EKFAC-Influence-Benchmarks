...
MODELDIR=/scratch/general/vast/u1420010/final_models/output_model/contract_nli/checkpoint-300
DATADIR=/scratch/general/vast/u1420010/final_models/data/contract_nli
...
python $WORKDIR/src/flan_test.py --data_dir DATADIR --ekfac_dir WORKDIR --cov_batch_num 5000 --output_dir $OUTDIR --model_dir $MODELDIR --layers $layerArray
kill $!