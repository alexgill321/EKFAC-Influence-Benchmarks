...
python $WORKDIR/src/flan_t5_test.py --data_dir $DATADIR --ekfac_dir $WORKDIR --cov_batch_num 1000 --output_dir $OUTDIR --model_dir $MODELDIR --layers $layerArray --test_start_idx 0 --test_end_idx 100
