...
python $WORKDIR/src/flan_t5_test_noaccel.py --data_dir $DATADIR --ekfac_dir $WORKDIR --cov_batch_num 300 --output_dir $OUTDIR --model_dir $MODELDIR --model_max_len 2000
